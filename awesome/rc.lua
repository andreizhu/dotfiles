...
-- {{{ Wibox
-- Initialize widget
thewidget = widget({ type = "textbox" })
-- Register widget
vicious.register(thewidget, vicious.widgets.thermal, "temp:$1°C ", 5, "thermal_zone0")

-- Initialize widget
memwidget = widget({ type = "textbox" })
-- Register widget
vicious.register(memwidget, vicious.widgets.mem, " mem:$1%/$2MB", 10)
...
globalkeys = awful.util.table.join(
   ...
   -- awful.key( {},"Print", function ()  awful.util.spawn("gnome-panel-screen")  end ),
